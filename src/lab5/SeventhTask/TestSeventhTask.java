...
import lab3.FirstTask.DequeException;
...
public class TestSeventhTask {
    ...
    void test1() {
        ...
        Integer answer1 = map.get(1);
        Assertions.assertEquals(null, answer1);
        map.put(1, 10);
        Integer answer2 = map.get(1);
        Assertions.assertEquals(10, answer2);
        Integer answer3 = map.delete(1);
        Assertions.assertEquals(10, answer3);
        Integer answer4 = map.get(1);
        Assertions.assertEquals(null, answer4);
    ...
    void test2() {
        ...
        HashTable<Integer, Integer> map = new HashTable<>(5);
        map.put(1, 10);
        map.put(1, 20);
        Integer answer1 = map.get(1);
        Assertions.assertEquals(20, answer1);
