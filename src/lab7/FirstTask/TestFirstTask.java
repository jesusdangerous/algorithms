...
public class TestFirstTask {
    ...
    void test1() {
        ...
        String answer = FirstTask.maximumSpanningTree(new String[]{});
        ...
        Assertions.assertTrue(elapsed < 200, "Метод выполняется слишком долго: " + elapsed + " мс");
    ...
    void test3() {
        ...
        Assertions.assertEquals("Oops! I did it again", answer);
        Assertions.assertTrue(elapsed < 200, "Метод выполняется слишком долго: " + elapsed + " мс");
        Assertions.assertTrue(memoryUsedMb < 64, "Метод потребляет слишком много памяти: " + memoryUsedMb + " Мб");
    }
