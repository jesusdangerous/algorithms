...
public class TestFifthTask {
    ...
    void test1() {
        ...
        String answer = FifthTask.getDecimalRepresentation(6, 70);
        ...
        Assertions.assertEquals("0.0(857142)", answer);
    ...
    void test2() {
        ...
        String answer = FifthTask.getDecimalRepresentation(17, 250);
        ...
        Assertions.assertEquals("0.068", answer);
        Assertions.assertTrue(elapsed < 1000, "Метод выполняется слишком долго: " + elapsed + " мс");
        Assertions.assertTrue(memoryUsedMb < 256, "Метод потребляет слишком много памяти: " + memoryUsedMb + " Мб");
    }
}
